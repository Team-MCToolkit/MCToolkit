...
public class AchievementGUI extends ModElementGUI<Achievement> {
	...
	@Override protected void initGUI() {
		...
		rewardLoot = new ModElementListField(mcreator, ModElementTypes.LOOTTABLE);
		rewardRecipes = new ModElementListField(mcreator, ModElementTypes.RECIPE);
	...
	@Override public void reloadDataLists() {
		...
		ComboBoxUtil.updateComboBoxContents(rewardFunction, ListUtils.merge(Collections.singleton("No function"),
				mcreator.getWorkspace().getModElements().stream().filter(e -> e.getType() == ModElementTypes.FUNCTION)
